...
Grab the latest build for your platform from [Releases](https://github.com/StarrySea1412/clipmaster/releases/latest):
...
│   ├── storage.ts         # Database & settings file paths
